...
class EnergyRoutes{
    ...
    config(): void{
        this.router.get('/list/:year&:month&:id_emp', energyController.list);
        this.router.get('/months/:year&:id_emp', energyController.listMonths);
        this.router.get('/reading/:date&:id_emp', energyController.getReading);
